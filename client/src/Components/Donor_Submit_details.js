...
import "../CSS/DonorSubmitdetails.css";
...
export default function DonorSubmitDetails() {
    const [state, setState] = useState({ web3: null, contract: null });
    const token=process.env.REACT_APP_WEB3_TOKEN;
    // const storage = new Web3Storage({ token });
    const navigate = useNavigate();

    //const [action,setAction] = useState("Donor");
      ...
      async function Submitted() {
        ...
        try {
          ...
          // } else {
            ...
            const transaction = contract.methods.donorSubmitDetails(
                pid,
                name,
                contact,
                age,
              ...
              if (confirmed) {
                ...
                // document.getElementById("con  tact").value = "";
         ...
         console.log(
           `Name: ${name}, Contact: ${contact}, Age: ${age}, organDonated: ${organDonated},Date: ${date},Blood Group: ${bloodGroup},  location: ${location}`
         );
       }
       useEffect(() => {
